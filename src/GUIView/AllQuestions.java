...
import GUIModel.QuestionTableModel;
 ...
 * @author ccks
 */
public class AllQuestions extends javax.swing.JInternalFrame {
     ...
     */
     public void loadTable(){
        try{
            List<Questions> lista = qr.findAll();
            qtm.addList(lista);
            table.setModel(qtm);
            ...
            public void valueChanged(ListSelectionEvent e) {
                ...
                if(selectedIndex > -1){
                   Questions q = qtm.getQuestions(selectedIndex);
                    EmertimiField.setText(q.getContent());
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try{
            ...
            Questions q = qtm.getQuestions(row);
            //Id nuk ndrrohet vetem field-at tjere
            q.setContent(EmertimiField.getText());
            qr.edit(q);
            clear();
            loadTable();
        }catch(QuizException ex){
